...
from ndlb_script.utils import readMhd, readCsv, getImgWorldTransfMats, convertToImgCoord, extractCube
from ndlb_script.readNoduleList import nodEqDiam

dispFlag = False

# Read nodules csv
csvlines = readCsv(r'training_set\trainNodules_gt.csv')
header = csvlines[0]
nodules = csvlines[1:]
